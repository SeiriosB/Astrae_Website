...
<div style="margin-top: 20px; margin-bottom: 20px;">
    <iframe src="{{ site.baseurl }}/assets/pdfs/main.pdf" width="100%" height="500px" style="border: none;">
    This browser does not support PDFs. Please download the PDF to view it: <a href="{{ site.baseurl }}/assets/pdfs/main.pdf">Download PDF</a>
    </iframe>
</div>

<p>
    <a href="{{ site.baseurl }}/assets/pdfs/main.pdf" class="btn btn-primary" download>Download Lecture Notes (PDF)</a>
</p>